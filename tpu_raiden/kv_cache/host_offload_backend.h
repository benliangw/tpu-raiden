...
class HostOffloadBackend : public KVCacheStoreBackend {
 ...
 private:
  ...
  // Body of InsertAndLock; the public method scopes the mutex around it and
  // issues the registry unregister for reclaimed candidates afterwards.
  bool InsertAndLockImpl(absl::Span<const std::string> block_hashes,
                         absl::Span<const RaidenBlockID> slices,
