  ...
  nb::class_<tpu_raiden::kv_cache::KVCacheStoreWrapper>(m, "KVCacheStore")
      ...
      .def(
          ...
          [](tpu_raiden::kv_cache::KVCacheStoreWrapper& self,
            ...
            auto res = self->Lookup(
                hashes, tpu_raiden::kv_cache::LookupOptions{
          ...
          "all matched replica pairs prior to the first miss. Local hits are "
          "pinned unless pin_found is false; registry-only hits never are.")
      .def(
          "insert",
          [](tpu_raiden::kv_cache::KVCacheStoreWrapper& self,
